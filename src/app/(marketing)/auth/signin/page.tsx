...
export default function SignIn() {
  ...
  // Public flag to control whether to show the email sign-in form
  const showEmail = process.env.NEXT_PUBLIC_ENABLE_EMAIL_SIGNIN === "true";
  ...
  const handleGoogleSignIn = async () => {
    setIsLoading(true);
    try {
      // Redirect is true by default; page will navigate after success
